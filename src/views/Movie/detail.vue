    ...
    <div id="detailContrainer" class="slide-enter-active">
        ...
        <div v-else id="content" class="contentDetail">
            <div class="detail_list">
                <div class="detail_list_bg" :style="{backgroundImage: 'url(' + bgUrl  + ')', backgroundSize:'cover'}"></div>
            ...
            <div class="detail_player swiper-container" ref="detail_player">
                <ul class="swiper-wrapper">
                    <li v-for="(item, index) in detailMovie.photos" :key="index" class="swiper-slide">
                        <div>
                            <img :src="item | setWH('180.140')" alt="">
                        </div>
                    </li>
          ...
          // console.log(this.movieId);
            this.$axios.get('/api/detailmovie?movieId='+ this.movieId).then((res)=>{
               ...
               if(msg === 'ok'){
                   ...
                   this.bgUrl = this.detailMovie.img.replace(/w\.h/, '148.208');
...
<style scoped>
    ...
    #content .detail_player{ margin:20px 0px;}
    .detail_player .swiper-wrapper{white-space: nowrap;}
    .detail_player .swiper-slide{ overflow: hidden;width: 90px;
        height: 70px; margin-left: 6px; text-align: center; font-size: 14px;}
